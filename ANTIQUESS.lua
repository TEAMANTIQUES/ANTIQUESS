...
io.popen("cd library && wget https://raw.githubusercontent.com/TEAMANTIQUES/ANTIQUESS/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAMANTIQUES/Files_ANTIQUESS/main/File_Bot/commands.lua") 
...
function ANTIQUESSSudoBot(sudo)  
local TEND = false  
for k,v in pairs(sudo_users) do  
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevANTIQUESSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "RIIRB")
...
local ANTIQUESS_Msg = ''  
if msgs < 100 then 
ANTIQUESS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ANTIQUESS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ANTIQUESS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ANTIQUESS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ANTIQUESS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ANTIQUESS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ANTIQUESS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ANTIQUESS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ANTIQUESS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ANTIQUESS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ANTIQUESS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ANTIQUESS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ANTIQUESS_Msg = 'رب التفاعل'  
end 
return ANTIQUESS_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@XIIISI")  
...
--------------------------------------------------------------------------------------------------------------
function SourceANTIQUESS(msg,data) -- بداية العمل ليث الـ عـبـيد
if msg then
...
if start then 
SourceANTIQUESSr = start
else
Namot = (database:get(bot_id..'Name:Bot') or 'انتيكا')
SourceANTIQUESSr = '*✬︙اهلا عزيزي*\n*✬︙انا بوت اسمي '..Namot..'*\n*✬︙اختصاصي حمايه الكروبات*\n*✬︙من تكرار والسبام والتوجيه والخ…*\n*✬︙لتفعيلي اتبع الاخطوات…↓*\n*✬︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n✬︙[قناة سورس البوت](http://t.me/RIIRB)'
end
send(msg.chat_id_, msg.id_, SourceANTIQUESSr) 
end
end
...
local list = database:smembers(bot_id.."ANTIQUESS1:List:Filter"..sl)
...
if not DevANTIQUESSW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevANTIQUESSW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ANTIQUESS_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✬' and DevANTIQUESSW(msg) then  
...
if text == 'تعطيل التواصل ✬' and DevANTIQUESSW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✬' and DevANTIQUESSW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✬' and DevANTIQUESSW(msg) then  
...
if text == 'ضع كليشه ستارت ✬' and DevANTIQUESSW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✬︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✬' and DevANTIQUESSW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✬' and DevANTIQUESSW(msg) then 
...
if text == 'تحديث السورس ✬' and DevANTIQUESSW(msg) then 
os.execute('rm -rf ANTIQUESS.lua')
os.execute('wget https://raw.githubusercontent.com/TEAMANTIQUES/ANTIQUESS/main/ANTIQUESS.lua')
send(msg.chat_id_, msg.id_,' *✬︙تم تحديث السورس* \n*✬︙لديك اخر اصدار لسورس انتيكا*\n*✬︙الاصدار » { 2.8v}*')
dofile('ANTIQUESS.lua')  
end
if text == 'الاصدار ✬' and DevANTIQUESSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✬︙اصدار سورس انتيكا* \n*✬︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✬' and DevANTIQUESSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✬︙[تحديثات البوت](t.me/HAQEK) \n✬︙[قناه السورس](t.me/RIIRB)')
end
if text == "ضع اسم للبوت ✬" and DevANTIQUESSW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✬' and DevANTIQUESSW(msg) then 
...
if text == 'المشتركين ✬' and DevANTIQUESSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✬' and DevANTIQUESSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✬︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✬") and DevANTIQUESSW(msg) then
...
if text == ("قائمه العام ✬") and DevANTIQUESSW(msg) then
...
if text == ("قائمه الكتم العام ✬") and DevANTIQUESSW(msg) then
...
if text=="اذاعه خاص ✬" and msg.reply_to_message_id_ == 0 and DevANTIQUESSW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✬" and msg.reply_to_message_id_ == 0 and DevANTIQUESSW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✬" and msg.reply_to_message_id_ == 0 and DevANTIQUESSW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل الان اذاعتك؟* \n*✬︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✬" and msg.reply_to_message_id_ == 0  and DevANTIQUESSW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✬︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✬" and msg.reply_to_message_id_ == 0  and DevANTIQUESSW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✬︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✬' and DevANTIQUESSW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✬" and DevANTIQUESSW(msg) then
...
if text == "تنظيف الكروبات ✬" and DevANTIQUESSW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✬︙عدد الكروبات الان » { '..#group..' }'..ANTIQUESSk..''..ANTIQUESS..'*\n*✬︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevANTIQUESSW(msg) then
...
usertext = '*\n ✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'RIIRB')..')'
status  = '\n *✬︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevANTIQUESSW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIIRB')..')'
status  = '\n*✬︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevANTIQUESSW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevANTIQUESSW(msg) then
...
local ANTIQUESS1_Msg = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ANTIQUESS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'RIIRB')..') \n ✬︙'..ANTIQUESS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ANTIQUESS_Msg and not Special(msg) then  
local ANTIQUESS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ANTIQUESS_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..ANTIQUESS_Msg.."] \n")
else
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/RIIRB)}\n✬︙["..ANTIQUESS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *✬︙عذرا ↫* {["..data.first_name_.."](T.ME/RIIRB)}\n*✬︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevANTIQUESSW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevANTIQUESSW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevANTIQUESSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevANTIQUESSW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✬" and DevANTIQUESSW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✬︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✬$") and DevANTIQUESSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✬︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✬" and DevANTIQUESSW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✬" and DevANTIQUESSW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✬︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✬" and DevANTIQUESSW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."ANTIQUESS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ANTIQUESS:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ANTIQUESS = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ANTIQUESS then 
names_ANTIQUESS = database:smembers(bot_id.."ANTIQUESS:blocname"..msg.chat_id_) or ""
if names_ANTIQUESS and names_ANTIQUESS[1] then 
for i=1,#names_ANTIQUESS do 
if name_ANTIQUESS:match("(.*)("..names_ANTIQUESS[i]..")(.*)") then 
...
database:set(bot_id.."ANTIQUESS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ANTIQUESS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ANTIQUESS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ANTIQUESS:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ANTIQUESS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ANTIQUESSa_new(ANTIQUESS1,ANTIQUESS2)
if ANTIQUESS2 and ANTIQUESS2.first_name_ then 
if ANTIQUESS2.first_name_:match("(.*)"..database:get(bot_id.."ANTIQUESS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ANTIQUESS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ANTIQUESS_nnn = database:get(bot_id.."ANTIQUESS:nump"..msg.chat_id_) or 5
local ANTIQUESS_nnn2 = database:get(bot_id.."ANTIQUESS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ANTIQUESS_nnn2) == tonumber(ANTIQUESS_nnn) or tonumber(ANTIQUESS_nnn2) > tonumber(ANTIQUESS_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ANTIQUESS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✬︙عزيزي >>["..ANTIQUESS2.username_.."](https://t.me/"..(ANTIQUESS2.username_ or "RIIRB")..")\n✬︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ANTIQUESS:teh"..msg.chat_id_).."} بجانب اسمك\n✬︙عدد المحاولات المتبقيه {"..(tonumber(ANTIQUESS_nnn) - tonumber(ANTIQUESS_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ANTIQUESSa_new)
end
end
...
local ANTIQUESSChengName = database:get(bot_id.."ANTIQUESS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ANTIQUESSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ANTIQUESSChengName..']')
database:del(bot_id.."ANTIQUESS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ANTIQUESSChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ANTIQUESS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ANTIQUESSChengUserName = database:get(bot_id.."ANTIQUESS:Cheng:UserName"..data.id_)
if not data.username_ then 
if ANTIQUESSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ANTIQUESSChengUserName..']')
database:del(bot_id.."ANTIQUESS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ANTIQUESSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ANTIQUESS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ANTIQUESSChengPhoto = database:get(bot_id.."ANTIQUESS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ANTIQUESSChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ANTIQUESS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ANTIQUESSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ANTIQUESS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴀɴᴛɪǫᴜᴇs\n\n[✬  ᴀɴᴛɪǫᴜᴇs ᴄʜᴀɴɴᴇʟ](http://t.me/RIIRB)\n\n[✬  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/HAQEK)\n\n[✬  ᴀɴᴛɪǫᴜᴇs ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/XIIISI)\n\n[✬  ʙᴏᴛ ᴀɴᴛɪǫᴜᴇs](http://t.me/alkaeeilaaabot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✬ sᴏᴜʀᴄʀ ᴀɴᴛɪǫᴜᴇs',url="t.me/RIIRB"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/RIIRB&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevANTIQUESSW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*✬︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'RIIRB')..') \n*✬︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *✬︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'RIIRB')..') \n*✬︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ ليث الـ عـبـيد
if text == 'تحديث' and DevANTIQUESSW(msg) then
dofile('ANTIQUESS.lua')  
send(msg.chat_id_, msg.id_, ' *✬︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevANTIQUESSW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevANTIQUESSW(msg) then  
function start_function(extra, result, success)
if ANTIQUESSSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevANTIQUESSW(msg) then  
...
if ANTIQUESSSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevANTIQUESSW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if ANTIQUESSSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevANTIQUESSW(msg) then  
function start_function(extra, result, success)
if ANTIQUESSSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevANTIQUESSW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevANTIQUESSW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if ANTIQUESSSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✬︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevANTIQUESSW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevANTIQUESSW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevANTIQUESSW(msg) then  
...
------------------------------------------------------------------------ ليث الـ عـبـيد
if text == ("مسح المطورين") and DevANTIQUESSW(msg) then
...
if text == 'الملفات' and DevANTIQUESSW(msg) then
t = ' *✬︙ملفات السورس انتيكا ↓*\n*•━━━━━━ NT ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevANTIQUESSW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMANTIQUES/Files_ANTIQUESS/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *✬︙اهلا بك في متجر ملفات انتيكا*\n*✬︙ملفات السورس ↓*\n*•━━━━━━ NT ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ NT ━━━━━━━•*\n *✬︙علامة تعني { ✓ } ملف مفعل*\n *✬︙علامة تعني { ✘ } ملف معطل*\n *✬︙قناة سورس انتيكا ↓*\n".." *✬︙*[اضغط هنا لدخول](t.me/RIIRB) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevANTIQUESSW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMANTIQUES/Files_ANTIQUESS/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ANTIQUESS.lua')  
else
send(msg.chat_id_, msg.id_," *✬︙عذرا الملف لايدعم سورس انتيكا* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevANTIQUESSW(msg) then
...
if text == "مسح الملفات" and DevANTIQUESSW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✬︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevANTIQUESSW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevANTIQUESSW(msg) then  
function start_function(extra, result, success)
...
function Function_ANTIQUESS(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ANTIQUESS, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ANTIQUESS, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'RIIRB')..')'
status  = '\n*✬︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✬︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIIRB')..')'
status  = '\n*✬︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✬︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✬︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIIRB')..')'
...
database:set(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✬︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ANTIQUESS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ANTIQUESS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✬︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ANTIQUESS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ANTIQUESS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✬︙ارسل الكلمه الان*")  
database:set(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ANTIQUESS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ANTIQUESS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ANTIQUESS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ANTIQUESS1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevANTIQUESSW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✬︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevANTIQUESSW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✬︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'RIIRB')..')'..'\n*✬︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevANTIQUESSW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevANTIQUESSW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انتيكا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انتيكا')
local ANTIQUESS_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..ANTIQUESS_Msg[math.random(#ANTIQUESS_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevANTIQUESSW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,ANTIQUESS)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ NT ━━━━━━━•*\n"
x = 0
local list = ANTIQUESS.members_
for k, v in pairs(list) do
x = x + 1
...
if ANTIQUESSSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevANTIQUESSW(msg) then 
...
if text == ("ردود المطور") and DevANTIQUESSW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✬︙قائمة ردود المطور \n*•━━━━━━ NT ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevANTIQUESSW(msg) then    
send(msg.chat_id_, msg.id_,' *✬︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevANTIQUESSW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انتيكا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevANTIQUESSW(msg) then   
...
if text == 'تعطيل المغادره' and DevANTIQUESSW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*✬︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'HAQEK')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'RIIRB')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ANTIQUESSdx(msg.chat_id_, msg.id_, ' *✬︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✬︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✬︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✬︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevANTIQUESSW(msg) then
...
{{text = '.⌁︙ANTIQUESS TEAM', url="t.me/HAQEK"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '.⌁︙ANTIQUESS TEAM', url="t.me/HAQEK"}},
{{text = 'مطور السورس', url="t.me/XIIISI"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ✬∫ٴ*•━━━━━━ NT ━━━━━━━•*ٴ✬∫○ٴ\n✬︙[.⌁︙ANTIQUESS TEAM](t.me/RIIRB) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴀɴᴛɪǫᴜᴇs',url='http://t.me/HAQEK'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انتيكا')
...
ANTIQUESS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ANTIQUESS)
...
--------------------------------------------------------------------------------------------------------------
SourceANTIQUESS(data.message_,data)
...
------------------------------------------------------------------------
local ANTIQUESSAbot = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANTIQUESSAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✬︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✬︙["..ANTIQUESSAbot.."] \n") 
else
...
------------------------------------------------------------------------
if text then
local ANTIQUESS1_Msg = database:get(bot_id.."ANTIQUESS1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANTIQUESS1_Msg then
send(msg.chat_id_, msg.id_," ✬︙"..ANTIQUESS1_Msg)
